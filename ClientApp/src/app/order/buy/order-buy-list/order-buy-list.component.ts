...
export class OrderBuyListComponent implements OnInit, AfterViewInit {
  ...
  filterForm: FormGroup;
    ...
    this.dataSource.loadData(this.pagingParams, this.sortParams, this.query);
  ...
  createFilterForm() {
    ...
    this.query.fromDate = this.filterForm.value.fromDate;
    this.query.toDate = this.filterForm.value.toDate;
    console.log(this.query);

		const filter = this.input.nativeElement.value;

		this.dataSource.loadData(this.pagingParams, this.sortParams, this.query, filter);
	}
