...
export class CategoryBuyListComponent implements OnInit, AfterViewInit {
  ...
  constructor(private categoryBuyService: CategoryBuyService, private router: Router, private dialog: MatDialog, private confirmService: ConfirmDialogService, private snackBar: MatSnackBar) {}
