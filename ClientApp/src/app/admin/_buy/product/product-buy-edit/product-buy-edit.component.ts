...
export class ProductBuyEditComponent implements OnInit, OnDestroy {
  ...
  getCategories() {
    this.categories$ = this.categoryBuyService
      .getCategories()
      .subscribe(res => {
        this.categories = res;
  ...
  getProduct(productId: number) {
    this.product$ = this.productBuyService
      .getProduct(productId)
      .subscribe((res: ProductBuyDetail) => {
        this.product = res;
  ...
  updateForm(product: ProductBuyDetail) {
  ...
  onSubmit() {
    ...
    if (this.editMode) {
      ...
      this.productBuyService
        .updateProduct(tempProductBuy)
        .subscribe((res: ProductBuy) => {
          if (res) {
      ...
      this.productBuyService
        .addProduct(tempProductBuy)
        .subscribe((res: ProductBuy) => {
          if (res) {
            this.router.navigate([`/admin/buy/product/${res.productId}/edit`]);
