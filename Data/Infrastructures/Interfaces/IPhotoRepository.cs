...
namespace Shine.Data.Infrastructures.Interfaces
{
    public interface IPhotoRepository : IRepository
    {
        ...
        Task<Photo> AddPhotoForEmployeeAsync(int employeeId, [FromForm] IFormFile file);

        Task<PhotoForEmployeeDto> SetMainPhotoForEmployeeAsync(PhotoForEmployeeDto photo);
